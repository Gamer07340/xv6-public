...
ST_FUNC void tcc_add_runtime(TCCState *s1)
{
    ...
    /* For xv6: skip libc and libtcc1, runtime already added in tcc_set_output_type */
    /* xv6 doesn't need additional runtime libraries */
    /* Runtime objects (ulib.o, usys.o, printf.o, umalloc.o, ansi.o) already added */
}
                           ...
                           struct dyn_inf *dyninf, int *sec_order)
{
    ...
    if (phnum > 0) {
		...
		ph->p_paddr &= ~(ph->p_align - 1);
            ...
            ph++;
            if (j == 0) {
                if (0 && s1->output_format == TCC_OUTPUT_FORMAT_ELF) {
